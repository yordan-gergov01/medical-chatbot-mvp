...
const ChatWidget = forwardRef<ChatWidgetHandle>((_props, ref) => {
  ...
  return (
    <>
      ...
      {/* Chat panel */}
      {isOpen && (
         <div className="fixed bottom-6 right-6 z-50 w-[380px] max-w-[calc(100vw-2rem)] h-[520px] max-h-[calc(100dvh-3rem)] bg-card rounded-2xl shadow-2xl border border-border flex flex-col animate-slide-up overflow-hidden">
